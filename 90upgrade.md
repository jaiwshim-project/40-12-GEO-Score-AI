...
/(전화|kakao|카카오|카톡|tel|message|메시지)/i
```
...
/(instagram|facebook|youtube|twitter|linkedin|kakao|naver|tiktok|쇼츠|reels)/i
```
...
#### ⑤ 멀티채널 (Channel) 보강
- 블로그, 인스타그램, 유튜브, 네이버블로그, 카카오 채널 중 3개 이상
...
- [ ] CTA 3종 이상 (상담/예약/카카오톡/전화)
- [ ] 고객 후기 3개 이상 + 별점/평점
- [ ] 멀티채널 5개 이상 (블로그/인스타/유튜브/네이버/카카오)
- [ ] 경쟁 비교 표
